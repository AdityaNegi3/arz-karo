...
// New Import: Privacy Policy Page
...
function parsePathname(pathname: string) {
  ...
  if (clean === '/privacy') return { page: 'privacy' as PageName }; // <-- NEW
    ...
    <div className="flex flex-col min-h-screen">
      ...
      */}
      <main className="flex-grow pt-16 md:pt-20">
        ...
        {/* New Page Rendering: Privacy Policy */}
      ...
      {/* Pass handleNavigate so Footer can trigger navigation (e.g., to 'terms', 'privacy', or 'thankyou') */}
